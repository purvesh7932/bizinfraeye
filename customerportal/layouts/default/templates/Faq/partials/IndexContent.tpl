...
<div class="row">
	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 faq_wrap">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 leftEditContent" style="padding-top:0;">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<h4 class="faq_heading"> {{'Top Questions'|translate}} </h4>
										<br>
						...
						<tbody>
							<tr class="listViewEntries" ng-repeat="documentrecord in documentsrecords">
								...
								<td ng-hide="documentsheader=='id'" class="listViewEntryValue medium" nowrap="" style='cursor: pointer;'>
									<span ng-if="documentrecord.documentExists" class="btn btn-soft-primary" ng-click="downloadFile('Documents',documentrecord.id,faqRecordId)">{{'Download'|translate}}</span>
								</td>
							</tr>
						</tbody>
					</table>
