...
<script type="text/ng-template" id="editRecordModal.template">
	<form class="form form-vertical" novalidate="novalidate" name="editForm">
																	...
																	<div ng-switch-when="date">
																		<ng-form name="innerForm" ng-class="{'has-error':innerForm.name.$error.required && submit}">
																			...
																			<p class="input-group datepicker">
																				...
																				<span class="input-group-btn">
																					<button type="button" class="btn btn-soft-secondary" ng-click="openDatePicker($event,$parent.editable.name)" ng-disabled="disabledFields[editable.name]"><i class="glyphicon glyphicon-calendar"></i></button>
																				</span>
																			</p>
																		</ng-form>
																	</div>
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-soft-danger" ng-click="cancel()" translate="Cancel"></button>
			<button type="submit" class="btn btn-soft-success" ng-click="save(editForm.$valid)" translate="Save"></button>
		</div>
	</form>
</script>
{/literal}
