...
class ServiceOrders_Record_Model extends Inventory_Record_Model {
    ...
    public function getAssociatedProductsSTOEnabled($module, $focus, $seid = '', $refModuleName = false) {
        global $log;
    ...
    public function getProductsForSTO() {
        $numOfCurrencyDecimalPlaces = getCurrencyDecimalPlaces();
        $relatedProducts = $this->getAssociatedProductsSTOEnabled($this->getModuleName(), $this->getEntity());
