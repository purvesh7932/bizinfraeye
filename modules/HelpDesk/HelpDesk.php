...
class HelpDesk extends CRMEntity {
	...
	var $tab_name = array(
		'vtiger_crmentity', 'vtiger_troubletickets',
		'vtiger_ticketcf', 'vtiger_inventoryproductrel'
	);
	var $tab_name_index = array(
		'vtiger_crmentity' => 'crmid',
		'vtiger_troubletickets' => 'ticketid',
		'vtiger_ticketcf' => 'ticketid', 'vtiger_ticketcomments' => 'ticketid',
	...
	function save_module($module)
	{
		...
		if($_REQUEST['action'] != 'HelpDeskAjax' && $_REQUEST['ajxaction'] != 'DETAILVIEW'
			...
			saveInventoryProductDetails($this, 'HelpDesk');
		}
	}
