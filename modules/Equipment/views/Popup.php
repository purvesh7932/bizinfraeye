...
class Equipment_Popup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		if ($relationId == '204') {
			...
			$popupEntryFromSEMOdal = true;
			$popupEntryFromSEMOdalsourceRecord = $sourceRecord;
		} 
		// $searchParams =  [[["equip_category", "c", "S"]]];
