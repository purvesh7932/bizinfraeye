<?php
class Owner_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if (empty($acceptStatus)) {
			$basicActionLink = array(
				'linktype' => 'DETAILVIEWBASIC',
				'linklabel' => 'Approve',
				'linkurl' => "javascript:Owner_Detail_Js.approveOrReject('index.php?module=" . $this->getModule()->getName() .
					"&action=ApproveOrReject&record=$recordId&source_module=Owner','Accepted')",
				'linkicon' => ''
			);
			...
			$basicActionLink = array(
				...
				'linklabel' => 'Reject',
				'linkurl' => "javascript:Owner_Detail_Js.approveOrReject('index.php?module=" . $this->getModule()->getName() .
					"&action=ApproveOrReject&record=$recordId&source_module=Owner', 'Rejected')",
				'linkicon' => ''
			);
			$linkModelList['DETAILVIEWBASIC'][] = Vtiger_Link_Model::getInstanceFromValues($basicActionLink);
		}
		...
		if($acceptStatus == 'Accepted' && $currentUserModel->isAdminUser()){
			...
			$passwordChangeUrl="Owner_Detail_Js.triggerChangePassword('index.php?module=Owner&action=SaveAjaxSavePassword&userid=$userId&serviceEngid=$serviceEngid')";
			$basicActionLink = array(
				'linktype' => 'DETAILVIEWBASIC',
