...
class Faq_Record_Model extends Vtiger_Record_Model {
	...
	public static function getServiceReportToFAQMappingFields() {
		return array(
			array('ticketField' => 'symptoms', 'faqField' => 'question', 'defaultValue' => ''),
			array('ticketField' => 'action_taken_block', 'faqField' => 'faq_answer', 'defaultValue' => ''),
		);
	}

	public static function getInstanceFromServiceReport($parentRecordModel) {
		$recordModel = Vtiger_Record_Model::getCleanInstance('Faq');
		$fieldMappingList = Faq_Record_Model::getServiceReportToFAQMappingFields();
