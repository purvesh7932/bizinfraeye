...
class ServiceEngineer_Save_Action extends Vtiger_Action_Controller {
	...
	public function saveRecord($request) {
		...
		if($recordId == ''){
			$focus = new Users();
			$focus->column_fields['user_name'] =   $_REQUEST['badge_no'];
			$focus->column_fields['first_name'] =  '';
			$focus->column_fields['last_name'] =  $_REQUEST['service_engineer_name'];
