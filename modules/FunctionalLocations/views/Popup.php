...
class FunctionalLocations_Popup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		if ($sourceModule == 'ServiceEngineer') {
			include_once('include/utils/IgClassUtils.php');
			$plantCode = IgClassUtils::getEmployeePlanCode(
				$sourceRecord
			);
			if (!empty($plantCode)) {
				$searchParams =  [[["plant_code", "e", $plantCode]]];
			}
		}
