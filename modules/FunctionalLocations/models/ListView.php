...
class FunctionalLocations_ListView_Model extends Vtiger_ListView_Model {
            ...
            if (empty($data)) {
                ...
                || $data['sub_service_manager_role'] == 'Regional Service Manager'))) {
					...
					if (empty($functionalLocations)) {
                        ...
                        $listQuery = $listQuery . ' AND vtiger_functionallocations.functionallocationsid IN ("' . implode('","', $functionalLocations) . '")';
                    }
                }
            }
        ...
        if (empty($data)) {
            ...
            || $data['sub_service_manager_role'] == 'Regional Service Manager'))) {
                ...
                if (empty($functionalLocations)) {
                    ...
                    $listQuery = $listQuery . ' AND vvtiger_functionallocations.functionallocationsid IN ("' . implode('","', $functionalLocations) . '")';
                }
            }
        }
