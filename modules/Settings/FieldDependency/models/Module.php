...
class Settings_FieldDependency_Module_Model extends Settings_Vtiger_Module_Model {

	var $baseTable = 'vtiger_field_dependency';
	var $baseIndex = 'id';
	var $name = 'FieldDependency';
	...
	public function getDefaultUrl() {
		return 'index.php?module=FieldDependency&parent=Settings&view=List';
	}
	...
	public function getCreateRecordUrl() {
		return "javascript:Settings_FieldDependency_Js.triggerAdd(event)";
	}
