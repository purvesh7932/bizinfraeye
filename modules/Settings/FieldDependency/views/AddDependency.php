...
class Settings_FieldDependency_AddDependency_View extends Settings_Vtiger_IndexAjax_View {
	...
	function GetPickListFields(Vtiger_Request $request) {
		...
		$fieldList = Settings_FieldDependency_Module_Model::getAvailablePicklists($module);
