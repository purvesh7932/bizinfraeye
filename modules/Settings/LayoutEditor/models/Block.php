...
class Settings_LayoutEditor_Block_Model extends Vtiger_Block_Model {
	...
	public function isAddCustomFieldEnabled() {
		...
		$blocksEliminatedArray = array(	'Calendar'		=> array('LBL_TASK_INFORMATION', 'LBL_DESCRIPTION_INFORMATION'),
										...
										'ServiceReports'	=> array('LBL_ITEM_DETAILS'),
										'RecommissioningReports'	=> array('LBL_ITEM_DETAILS'),
										'ServiceOrders' => array('PARTS_FROM_SR'),
										'FailedParts'	=> array('LBL_ITEM_DETAILS'),
										'ReturnSaleOrders'	=> array('LBL_ITEM_DETAILS'),
										'StockTransferOrder'	=> array('LBL_ITEM_DETAILS'),
