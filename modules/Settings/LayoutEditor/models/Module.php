...
class Settings_LayoutEditor_Module_Model extends Vtiger_Module_Model {
	...
	public function getAddSupportedFieldTypes() {
		return array(
			...
			'URL','Checkbox','TextArea','MultiSelectCombo','Skype','Time','Radio'
		);
	}
	...
	public function addField($fieldType, $blockId, $params) {
		...
		if($fieldType == 'Picklist' || $fieldType == 'MultiSelectCombo' || $fieldType == 'Radio') {
	...
	public function isFieldsSortableAllowed($blockName) {
		...
		$blocksEliminatedArray = array('HelpDesk' => array('LBL_TICKET_RESOLUTION', 'LBL_COMMENTS'),
										...
										'FailedParts' => array('LBL_ITEM_DETAILS1'),
										'ReturnSaleOrders'	=> array('LBL_ITEM_DETAILS1'),
										'SalesOrder' => array('LBL_ITEM_DETAILS1'),
										'ServiceOrders' => array('PARTS_FROM_SR1'),
										'ServiceReports'	=> array('LBL_ITEM_DETAILS1'),
										'RecommissioningReports'	=> array('LBL_ITEM_DETAILS1'),
										'StockTransferOrders'	=> array('LBL_ITEM_DETAILS'),
