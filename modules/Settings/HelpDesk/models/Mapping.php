...
class Settings_HelpDesk_Mapping_Model extends Settings_Leads_Mapping_Model {
	...
	public function getHeaders() {
		return array('HelpDesk' => 'HelpDesk', 'Type' => 'Type', 'ServiceReports' => 'ServiceReports');
	}
	...
	public function getDetailViewLinks() {
		return array(Vtiger_Link_Model::getInstanceFromValues(array(
				'linktype' => 'DETAILVIEW',
				'linklabel' => 'LBL_EDIT',
				'linkurl' => 'javascript:Settings_HelpDeskMapping_Js.triggerEdit("'. $this->getEditViewUrl() .'")',
				'linkicon' => ''
				)));
	}
	...
	public function getMappingLinks() {
		return array(Vtiger_Link_Model::getInstanceFromValues(array(
				...
				'linkurl' => 'javascript:Settings_HelpDeskMapping_Js.triggerDelete(event,"'. $this->getMappingDeleteUrl() .'")',
				'linkicon' => ''
				)));
	}
	 ...
	 * @return <Settings_HelpDesk_Mapping_Model>
	 */
