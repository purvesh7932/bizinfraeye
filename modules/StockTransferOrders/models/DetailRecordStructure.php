 ...
 */
class StockTransferOrders_DetailRecordStructure_Model extends Vtiger_DetailRecordStructure_Model {
	...
	public function getStructure() {
		...
		foreach($blockModelList as $blockLabel=>$blockModel) {
			if($blockLabel == 'LBL_ITEM_DETAILS' || $blockLabel == 'LBL_SYSTEM_INFORMATION'){
				continue;
			}
