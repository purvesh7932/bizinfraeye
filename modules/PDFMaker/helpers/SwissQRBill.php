...
class PDFMaker_SwissQRBill_Helper
{
     ...
     */
    function __construct($invoiceId, $referenceNumber)
    {
     ...
     * @return bool
     */
    public function isUseRecipientName(): bool
    {
     ...
     */
    public function setUseRecipientName(bool $useRecipientName): void
    {
     ...
     * @return bool
     */
    public function isPopulateAmount(): bool
    {
     ...
     */
    public function setPopulateAmount(bool $populateAmount): void
    {
     ...
     */
    public static function getSwissQRBill(int $invoiceId, string $referenceNumber, bool $useRecipientName = false): string
    {
     ...
     * @return text
     */
    public static function getSwissNoAmountQRBill(int $invoiceId, bool $useRecipientName = false): string
    {
        if (self::$instance == null) {
     ...
     * @return string
     */
    private static function getQrBill($display = false): string
    {
        if ($display) {
    ...
    private function setSwissPaymentInformation($invoiceId)
    {
        if ($invoiceId) {
            ...
            $this->paymentData['invoice'] = array(
            ...
            $userId = $invoiceRow['assigned_user_id'];
            ...
            */
            ...
            die('Invoice ID can not be empty for Swiss QR Bill !');
        }
    }
    ...
    {
        $thousandsSeparator = (isset($thousandsSeparator) ? $thousandsSeparator : self::$thousandsSeparator);
