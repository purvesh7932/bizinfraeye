...
class PDFMaker_IndexAjax_View extends Vtiger_Index_View {
    ...
    public function getPreview(Vtiger_Request $request){
        ...
        $file_path = 'index.php?module=PDFMaker&action=IndexAjax&mode=getPreviewContent&source_module='.$source_module."&language=".$language.'&igtempid='.$request->get("igtempid");
        ...
        if ($attr_path != "") $file_path .= "&".$attr_path;
