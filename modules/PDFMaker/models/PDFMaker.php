...
class PDFMaker_PDFMaker_Model extends Vtiger_Module_Model {
    ...
    public function GetPreparedMPDF(&$mpdf, $record, $module, $language,$tempid) {
        ...
        $PDFContent = $this->GetPDFContentRef($module, $focus, $language,$tempid);
    ...
    public function GetPDFContentRef($module, $focus, $language,$tempid) {
        return new PDFMaker_PDFContent_Model($module, $focus, $language, $tempid);
    }
