    ...
    public function doTask($entity)
    {
        ...
        if (!empty($to_email)) {
            ...
            if (vtlib_isModuleActive('EMAILMaker')) {
                $EMAILContentModel = EMAILMaker_EMAILContent_Model::getInstance($module, $entityId, $this->template_language);
            ...
            $emailFocus->column_fields['parent_id'] = $entityId;
...
*/
            ...
            while($row = $adb->fetchByAssoc($res)) {
                ...
                $filename = decode_html($row['storedname']);
                $filepath = $row['path'];
