...
class Companies extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_companies';
	var $table_index= 'companiesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_companiescf', 'companiesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_companies', 'vtiger_companiescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_companies' => 'companiesid',
		'vtiger_companiescf'=>'companiesid');
	...
	function Companies() {
		$this->log =LoggerManager::getLogger('Companies');
		$this->db = PearDatabase::getInstance();
		$this->column_fields = getColumnFields('Companies');
	}
