...
class Vtiger_Field_Model extends Vtiger_Field {
	...
	public function getPicklistValues() {
        ...
        if($fieldDataType == 'picklist' || $fieldDataType == 'multipicklist' || $fieldDataType == 'metricpicklist' || $fieldDataType == 'timestring' ||  $fieldDataType == 'radio') {
			...
			if (!in_array($fieldName, array('hdnTaxType', 'region_id')) && !in_array($this->getModuleName(), array('Users'))) {
				...
				if (Vtiger_Utils::CheckTable($tableName)) {
					if (is_array($picklistValues) && count($picklistValues)) {
						$result = $db->pquery("SELECT $fieldName, color FROM $tableName ", array());
