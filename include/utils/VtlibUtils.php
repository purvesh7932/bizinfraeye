...
function __vtlib_get_modulevar_value($module, $varname) {
	$mod_var_mapping =
		Array(
			...
			Array(
				'IsCustomModule'=>false,
				'table_name' => 'vtiger_servicereports',
				'table_index'=> 'servicereportsid',
				'related_tables'=> Array( 
					'vtiger_servicereportscf' => Array('servicereportsid'),
					'vtiger_inventoryproductrel_other' => Array('id','vtiger_servicereports','servicereportsid'),
				),
			)
	);
