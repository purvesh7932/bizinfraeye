							...
							{foreach item=FIELD_MODEL key=FIELD_NAME from=$FIELD_MODEL_LIST}
								...
								{else}
									...
									{else}
										{assign var=COUNTER value=$COUNTER+1}
									{/if}
									{if $FIELD_MODEL->getName() eq 'pincode'}
										<tr><td class="fieldLabel" style="width: 100%"><h4 class="" style="width: 300px;" id="currentEqLocationHolder">Current Equipment Location</h4></td></tr>
									{/if}
