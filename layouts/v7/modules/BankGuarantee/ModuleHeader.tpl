{strip}
	<div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-6 col-md-6 col-sm-5 col-xs-11 padding0 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
			...
			<div class="col-lg-6 col-md-6 col-sm-7 col-xs-1 padding0 pull-right">
									...
									{if $USER_MODEL->isAdminUser()}
										<li>
											<button id="{$MODULE}_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync To SAP')}" type="button" class="btn addButton btn-soft-info module-btn"
												onclick="BankGuarantee_List_Js.syncToSAPFunction('BankGuarantee')">
												<div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;
												Sync To SAP
											</button>
										</li>
										<li>
											<button id="{$MODULE}_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores('Calculate BG Status')}" type="button" class="btn addButton btn-soft-info module-btn"
												onclick="BankGuarantee_List_Js.AutoUpdateBGStatusINPeriodic('BankGuarantee')">
												<div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;
												Calculate BG Status
											</button>
										</li>
