                    ...
                    <tbody>
                        {foreach key=MAPPING_ID item=MAPPING from=$MODULE_MODEL->getMapping()}
                            <tr class="listViewEntries" data-cfmid="{$MAPPING_ID}">
                                ...
                                <td>{vtranslate({$MAPPING['HelpDesk']['label']}, 'HelpDesk')}</td>
                                <td>{vtranslate($MAPPING['HelpDesk']['fieldDataType'], $QUALIFIED_MODULE)}</td>
                                <td>{vtranslate({$MAPPING['ServiceReports']['label']}, 'ServiceReports')}</td>
                            </tr>
                        {/foreach}
                    </tbody>
                </table>
