Vtiger.Class('Settings_FieldDependency_Js', {
	
	//holds the picklist dependency instance
	FieldDependencyInstance : false,
	...
	triggerAdd : function(event) {
		...
		var instance = Settings_FieldDependency_Js.FieldDependencyInstance;
	...
	triggerEdit : function(event, module, sourceField, targetField) {
		...
		instance.showEditView(module, sourceField, targetField).then(
			function(data){
				var form = jQuery('#FieldDependencyForm');
	...
	init : function() {
            this.addComponents();
            Settings_FieldDependency_Js.FieldDependencyInstance = this;
	},
	...
	addNewDependencyPickList : function(sourceModule, sourceFieldValue, targetFieldValue) {
		...
		app.request.post({data: params}).then(
			function(error, data) {
				...
				element.find('.FieldDependencyTable').find('tr.blockHeader').find('th').each(function(i, row) {
	...
	updateValueMapping : function(dependencyGraph) {
		...
		var dependencyTable = dependencyGraph.find('.FieldDependencyTable');
	 ...
	 */
	saveFieldDependency : function(form) {
		var thisInstance = this;
		app.helper.showProgress();
	...
	registerSubmitEvent : function() {
        ...
        var params = {
            submitHandler: function(form) {
                ...
                thisInstance.saveFieldDependency(form);
            }
        };
...
Settings_FieldDependency_Js('Settings_FieldDependency_List_Js',{},{});
Settings_FieldDependency_Js('Settings_FieldDependency_Edit_Js',{},{});