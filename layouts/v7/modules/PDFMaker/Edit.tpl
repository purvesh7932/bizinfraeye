...
-->*}
{strip}
<div class="contents tabbable ui-sortable" style="margin-bottom: 70px;">
                        ...
                        <div>
                            <div class="tab-content layoutContent themeTableColor overflowVisible">
                                <div class="tab-pane active" id="pdfContentEdit">
                                    ...
                                    <div class="edit-template-content col-lg-4">
                                        <br />
                                        {********************************************* PROPERTIES DIV*************************************************}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls col-sm-9">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td align="right" nowrap>{vtranslate('LBL_CURRENCY_POINT',$MODULE)}</td>
                                                        ...
                                                        <tr>
                                                            <td align="right" nowrap>{vtranslate('LBL_CURRENCY_DECIMALS',$MODULE)}</td>
