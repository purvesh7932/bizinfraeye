    ...
    <input type="hidden" name="mode" value="SaveProductBlock" /> 
        ...
        <div class="contents tabbable ui-sortable">
            <ul class="nav nav-tabs layoutTabs massEditTabs">
                 <li class="active detailviewTab"><a data-toggle="tab" href="#pContentEdit">{vtranslate('LBL_PROPERTIES_TAB','PDFMaker')}</a></li>
                <li class="detailviewTab"><a data-toggle="tab" href="#pContentLabels">{vtranslate('LBL_LABELS','PDFMaker')}</a></li>
            </ul>
            ...
            <div class="tab-content layoutContent themeTableColor overflowVisible">
                ...
                <div  class="tab-pane active" id="pContentEdit">
                    ...
                    <table class="table no-border">
                        <tbody>
                        <tr>
                            <td class="fieldLabel alignMiddle"><label class="muted pull-right">{vtranslate('LBL_PDF_NAME','PDFMaker')}: <span class="redColor">*</span></label></td>
                        ...
                        <tr>
                            ...
                            <td class="fieldValue">
                                ...
                                <button type="button" class="btn btn-success small create" onclick="InsertIntoTemplate('articelvar');"><i class="fa fa-usd"></i> {vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}</button>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="fieldValue">
                                ...
                                <button type="button" class="btn btn-success small create" onclick="InsertIntoTemplate('psfields');"><i class="fa fa-usd"></i> {vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}</button>
                            </td>
                        </tr>
                        {* products fields *}
                        <tr>
                            ...
                            <td class="fieldValue">
                                ...
                                <button type="button" class="btn btn-success small create" onclick="InsertIntoTemplate('productfields');"><i class="fa fa-usd"></i> {vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}</button>
                            </td>
                        </tr>
                        {* services fields *}
                        <tr>
                            ...
                            <td class="fieldValue">
                                ...
                                <button type="button" class="btn btn-success small create" onclick="InsertIntoTemplate('servicesfields');"><i class="fa fa-usd"></i> {vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}</button>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="tab-pane" id="pContentLabels">
                    <table class="table no-border">
                        <tr>
                            <td class="fieldLabel alignMiddle"><label class="muted pull-right">{vtranslate('LBL_GLOBAL_LANG','PDFMaker')}:</label></td>
                            <td class="fieldValue">
