Vtiger_AdvanceFilter_Js('PDFMaker_AdvanceFilter_Js',{},{
...
Vtiger_Field_Js('PDFMaker_Field_Js',{},{
    ...
    getUi : function() {
        var html = '<input type="text" class="getPopupUi inputElement" name="'+ this.getName() +'"  /><input type="hidden" name="valuetype" value="'+this.get('pdfmaker_valuetype')+'" />';
        html = jQuery(html);
        html.filter('.getPopupUi').val(app.htmlDecode(this.getValue()));
        return this.addValidationToElement(html);
    }
});
PDFMaker_Field_Js('PDFMaker_Text_Field_Js', {}, {
    getUi : function() {
...
Vtiger_Date_Field_Js('PDFMaker_Date_Field_Js',{},{
        ...
        if(comparatorSelectedOptionVal.length > 0) {
                if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
                        ...
                        var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
                                                <input type="hidden" name="valuetype" value="'+this.get('pdfmaker_valuetype')+'" />';
                        return jQuery(html);
...
Vtiger_Date_Field_Js('PDFMaker_Datetime_Field_Js',{},{
	getDateFormat : function(){
		return this.get('date-format');
	},
	getUi : function() {
		...
		if(this._specialDateTimeComparator(comparatorSelectedOptionVal)) {
			var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validator="[{name:PositiveNumber}]"><input type="hidden" name="valuetype" value="'+this.get('pdfmaker_valuetype')+'" />';
			var element = jQuery(html);
        } else if(comparatorSelectedOptionVal == 'is today' || comparatorSelectedOptionVal == 'is tomorrow' || comparatorSelectedOptionVal == 'is yesterday') {
		} else {
...
Vtiger_Currency_Field_Js('PDFMaker_Currency_Field_Js',{},{
    getUi : function() {
...
Vtiger_Time_Field_Js('PDFMaker_Time_Field_Js',{},{
    getUi : function() {
...
Vtiger_Owner_Field_Js('PDFMaker_Owner_Field_Js',{},{
    getUi : function() {
...
Vtiger_Owner_Field_Js('PDFMaker_Ownergroup_Field_Js',{},{
    getUi : function() {
...
Vtiger_Picklist_Field_Js('PDFMaker_Picklist_Field_Js',{},{
    getUi : function(){
