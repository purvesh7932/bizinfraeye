    ...
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                {if $editAction}
                    <button type="button" class="btn btn-soft-info" id={$MODULE}_listView_massAction_{$editAction->getLabel()} 
                ...
                {/if}
                {if $deleteAction}
                    <button type="button" class="btn btn-soft-danger" id={$MODULE}_listView_massAction_{$deleteAction->getLabel()} 
                ...
                {/if}
                {if $commentAction}
                    <button type="button" class="btn btn-soft-primary" id="{$MODULE}_listView_massAction_{$commentAction->getLabel()}" 
