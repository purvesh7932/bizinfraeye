...
Vtiger.Class("Vtiger_Detail_Js",{
	...
	*/
	...
	campaigngetdata: function () {
        var self = this; 
        jQuery('#getrelcampaignemail').live('click', function (e) {
            var element = jQuery(e.currentTarget);
            var record = self.getRecordId();
            var moduleName = app.getModuleName();
            window.location.replace("index.php?module="+moduleName+"&view=EmailDashboard&record="+record+"&mode=emailinfo&app=MARKETING");
