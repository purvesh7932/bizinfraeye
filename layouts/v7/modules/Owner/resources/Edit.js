Vtiger_Edit_Js("Owner_Edit_Js", {}, {
	...
	// hide: function () {
	// 	$("#Owner_editView_fieldName_rejection_reason").parent().parent().parent().parent().addClass("hide");

	// 	$('select').on('change', function () {
	// 		var name = this.value;
	// 		if (name == "Rejected") {
	// 			$("#Owner_editView_fieldName_rejection_reason").parent().parent().parent().parent().removeClass("hide");
	...
	phoneCountryCode: function () {
		var input = document.querySelector("#Owner_editView_fieldName_phone"),
		errorMsg = document.querySelector("#phone_error-msg"),
		validMsg = document.querySelector("#phone_valid-msg");
		if(input){
			$(document).ready(function () {
				$('#Owner_editView_fieldName_phone').attr('type', 'tel');
			});
