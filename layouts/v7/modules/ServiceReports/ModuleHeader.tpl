						...
						<div class="container-fluid">
							...
							<div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;">
								...
								{if $MODULE_BASIC_ACTIONS|@count gt 0}
									...
									{/foreach}
								{/if}
									{if $USER_MODEL->isAdminUser() and $smarty.request.view eq 'List'}
										<li>
											<button id="{$MODULE}_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync Settings Master')}" type="button" class="btn addButton btn-soft-info module-btn"
												onclick="ServiceReports_List_Js.syncToSAPForSettingsMaster('')">
