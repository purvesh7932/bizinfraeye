...
<div class='fc-overlay-modal modal-content'>
    ...
    <div class='modal-footer overlayFooter'>
        <footer>
            <center><button class='btn-soft-dark btn-lg undoDoneButton' data-dismiss="modal" onclick="Vtiger_Import_Js.finishUndoOperation();">{vtranslate('LBL_DONE_BUTTON', $MODULE)}</button></center>
        </footer>
    </div>
</div>
