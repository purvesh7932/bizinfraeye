       ...
       <div class="row clearfix">
            <div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
                ...
                {if $MERGE_ENABLED eq '0'}
                    ...
                    &nbsp;&nbsp;&nbsp;
                {/if}
                <button class='btn btn-soft-success btn-lg' data-dismiss="modal" onclick="Vtiger_Import_Js.loadListRecords();">{vtranslate('LBL_FINISH', $MODULE)}</button>
            </div>
        </div>
    </div>
</div>
