...
{strip}
    ...
    {/foreach}
    <div class="modal-dialog modal-lg callassistancemodal">
    ...
    <link type="text/css" rel="stylesheet" href="layouts/v7/modules/Users/build/css/intlTelInput.css?v=7.3.0" media="screen">
{/strip}