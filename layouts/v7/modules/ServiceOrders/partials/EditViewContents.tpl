...
<div name='editContent' style="padding-top: 30px;">
    ...
    {if $EXTERNALERRORISTHERE}
		<div class="fieldBlockContainer duplicationMessageContainer">
			<div class="duplicationMessageHeader"><b>Service Order Is Created/Updated In CRM, But Sync To SAP , Has Failed , Please Fix Following Errors</b></div>
			<div>{$EXTERNALERROR}</div>
		</div>
	{/if}
    {foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name=blockIterator}
        {if $BLOCK_LABEL eq 'LBL_ITEM_DETAILS' or $BLOCK_LABEL eq 'PARTS_FROM_SR'}{continue}{/if}
...
{if $MODE neq 'edit'}
    {include file="partials/LineItemsEdit1.tpl"|@vtemplate_path:'ServiceOrders'}
{/if}
{include file="partials/LineItemsEdit.tpl"|@vtemplate_path:'ServiceOrders'}